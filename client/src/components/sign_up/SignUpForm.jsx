...
const SignUpForm = () => {
  ...
  <div className="mx-auto max-w-lg">
    <h1 className="text-center text-2xl font-bold text-teal-600 sm:text-3xl">Register</h1>
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8 bg-teal-700">
      ...
      <div>
        ...
        <div className="relative">
          ...
          {...register('username')}
            type="text"
            className="w-full  border-gray-200 p-4 pe-12 text-sm shadow-sm  text-gray-900"
      ...
      <div className="flex justify-center mx-auto"><Link to={"/login"}><p className="text-sm ">Login</p></Link></div>
    </form>
  </div>
</div>
        </>
